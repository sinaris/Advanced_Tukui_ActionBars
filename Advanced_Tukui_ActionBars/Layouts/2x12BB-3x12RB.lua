...
if( ataCoreCDB['ActionBars']['ActionBars_Layout'] ~= 1 ) then
	return
end
...
A['ActionBars']['ActionBars3']:SetPoint( 'RIGHT', UIParent, 'RIGHT', -28, -14 )
A['ActionBars']['ActionBars3']:SetHeight( ( Size * 12 ) + ( Spacing * 13 ) )
A['ActionBars']['ActionBars3']:SetWidth( ( Size * 1 ) + ( Spacing * 2 ) )
...
A['ActionBars']['ActionBars4']:SetPoint( 'RIGHT', A['ActionBars']['ActionBars3'], 'RIGHT', 0, 0 )
A['ActionBars']['ActionBars4']:SetHeight( ( Size * 12 ) + ( Spacing * 13 ) )
...
A['ActionBars']['ActionBars5']:SetPoint( 'RIGHT', A['ActionBars']['ActionBars4'], 'RIGHT', 0, 0 )
