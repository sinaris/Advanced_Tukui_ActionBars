...
if( ataCoreCDB['ActionBars']['ActionBars_Layout'] ~= 2 ) then
	return
end
...
A['ActionBars']['ActionBars3']:SetPoint( 'BOTTOM', A['ActionBars']['ActionBars1'], 'BOTTOM', 0, 0 )
...
A['ActionBars']['ActionBars4']:SetPoint( 'RIGHT', UIParent, 'RIGHT', -28, -14 )
A['ActionBars']['ActionBars4']:SetHeight( ( Size * 12 ) + ( Spacing * 13 ) )
A['ActionBars']['ActionBars4']:SetWidth( ( Size * 1 ) + ( Spacing * 2 ) )
