...
if( ataCoreCDB['ActionBars']['ActionBars_Layout'] ~= 4 ) then
	return
end
...
A['ActionBars']['ActionBars5']:SetPoint( 'BOTTOM', A['ActionBars']['ActionBars4'], 'BOTTOM', 0, 0 )
A['ActionBars']['ActionBars5']:SetHeight( ( Size * 5 ) + ( Spacing * 6 ) )
A['ActionBars']['ActionBars5']:SetWidth( ( Size * 12 ) + ( Spacing * 13 ) )
...
hooksecurefunc( TG['UnitFrames'], 'CreateAnchor', function()
	...
	TG['UnitFrames']['Anchor']:SetHeight( ( Size * 5 ) + ( Spacing * 6 ) )
