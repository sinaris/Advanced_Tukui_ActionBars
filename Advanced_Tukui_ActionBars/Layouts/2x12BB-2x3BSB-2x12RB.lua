...
if( ataCoreCDB['ActionBars']['ActionBars_Layout'] ~= 5 ) then
	return
end
...
A['ActionBars']['ActionBars3']:SetHeight( ( Size * 2 ) + ( Spacing * 3 ) )
A['ActionBars']['ActionBars3']:SetWidth( ( Size * 3 ) + ( Spacing * 4 ) )
...
do
	...
	for i = 1, 12 do
		...
		if( i == 1 ) then
			Button:SetPoint( 'TOPLEFT', AnchorLeft, Spacing, -Spacing )
		elseif( i == 4 ) then
			Button:SetPoint( 'BOTTOMLEFT', AnchorLeft, Spacing, Spacing )
		elseif( i == 7 ) then
			Button:SetPoint( 'TOPLEFT', AnchorRight, Spacing, -Spacing )
		elseif( i == 10 ) then
			Button:SetPoint( 'BOTTOMLEFT', AnchorRight, Spacing, Spacing )
		else
			Button:SetPoint( 'LEFT', Previous, 'RIGHT', Spacing, 0 )
		end
	end
