...
if( ataCoreCDB['ActionBars']['ActionBars_Layout'] ~= 9 ) then
	return
end
...
A['ActionBars']['ActionBars2']:SetPoint( 'BOTTOMRIGHT', A['ActionBars']['ActionBars1'], 'BOTTOMRIGHT', 0, 0 )
...
A['ActionBars']['ActionBars3']:SetPoint( 'TOPLEFT', A['ActionBars']['ActionBars1'], 'TOPLEFT', 0, 0 )
...
A['ActionBars']['ActionBars4']:SetPoint( 'TOPRIGHT', A['ActionBars']['ActionBars1'], 'TOPRIGHT', 0, 0 )
A['ActionBars']['ActionBars4']:SetHeight( ( Size * 1 ) + ( Spacing * 2 ) )
